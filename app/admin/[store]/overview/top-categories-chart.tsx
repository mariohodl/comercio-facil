                    ...
                    <div className='h-[200px] w-[200px] relative'>
                        <ResponsiveContainer width='100%' height='100%'>
                            <PieChart>
                                ...
                                <Tooltip formatter={(value: number) => [value, t('sales')]} />
                            </PieChart>
                        </ResponsiveContainer>
                    </div>
                        ...
                        {data.slice(0, 3).map((entry, index) => (
                            <div key={index} className='flex items-center gap-2'>
                                ...
                                <div>
                                    ...
                                    <p className='font-bold'>{entry.totalSales} <span className='text-xs font-normal text-muted-foreground'>{t('sales')}</span></p>
                                </div>
                            </div>
                        ))}
                    </div>
